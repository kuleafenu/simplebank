...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		fmt.Println(">> after 0: account1.Balance ", account1.Balance, "fromAccount.Balance", fromAccount.Balance)
		fmt.Println(">> after 0: account2.Balance ", account2.Balance, "toAccount.Balance", toAccount.Balance)

		diff1 := account1.Balance - fromAccount.Balance
		diff2 := toAccount.Balance - account2.Balance
		fmt.Println(">> diff1:diff2", diff1, diff2)
